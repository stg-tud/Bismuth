...
class RescalatagsTest extends FunSuite {
  ...
  test(
    "put var into dom".ignore.pending("needs jsdom; https://github.com/scala-js/scala-js-env-jsdom-nodejs/pull/63")
  ) {
  ...
  test(
    "put style into dom".ignore.pending("needs jsdom; https://github.com/scala-js/scala-js-env-jsdom-nodejs/pull/63")
  ) {
  ...
  test("put attribute into dom".ignore.pending(
    "needs jsdom; https://github.com/scala-js/scala-js-env-jsdom-nodejs/pull/63"
  )) {
  ...
  test("work with multiple children".ignore.pending(
    "needs jsdom; https://github.com/scala-js/scala-js-env-jsdom-nodejs/pull/63"
  )) {
