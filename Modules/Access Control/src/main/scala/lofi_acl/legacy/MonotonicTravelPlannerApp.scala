package lofi_acl.legacy

import crypto.channels.IdentityFactory
import lofi_acl.legacy.monotonic.MonotonicAclSyncMessage.AclDelta
import lofi_acl.legacy.monotonic.SyncWithMonotonicAcl.messageJsonCodec
import lofi_acl.legacy.monotonic.{MonotonicAcl, MonotonicInvitation, SyncWithMonotonicAcl}
import lofi_acl.travelplanner.model.{TravelPlanModel, TravelPlanModelFactory}
import lofi_acl.travelplanner.{MainScene, TravelPlan}
