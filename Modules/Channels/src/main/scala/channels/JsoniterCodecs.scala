...
object JsoniterCodecs {
  ...
  given causalTimeCodec: JsonValueCodec[CausalTime] = JsoniterCodecs.bimapCodec[Array[Long], CausalTime](
    arrayOfLongCodec,
  ...
  given dotCodec: JsonValueCodec[Dot] = bimapCodec[(Uid, Time), Dot](
    JsonCodecMaker.make,
    tuple => if tuple != null then Dot(tuple._1, tuple._2) else Dot.zero,
