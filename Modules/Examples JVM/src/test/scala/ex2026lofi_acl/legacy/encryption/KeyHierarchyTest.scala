...
import ex2026lofi_acl.legacy.encryption.{DeltaSurgeon, FullKeyHierarchy, KeyDerivationKey, KeyHierarchy}
...
class KeyHierarchyTest extends FunSuite {
  ...
  private given lwwSurgeon: DeltaSurgeon[LastWriterWins[Option[String]]] = {
    import ex2026lofi_acl.legacy.encryption.DeltaSurgeon.given
