package ex2026lofi_acl.legacy

import crypto.channels.IdentityFactory
import ex2026lofi_acl.legacy.monotonic.MonotonicAclSyncMessage.AclDelta
import ex2026lofi_acl.legacy.monotonic.{MonotonicAcl, MonotonicInvitation, SyncWithMonotonicAcl}
import ex2026lofi_acl.legacy.monotonic.SyncWithMonotonicAcl.messageJsonCodec
import ex2026lofi_acl.travelplanner.{MainScene, TravelPlan}
