package ex2024travel.lofi_acl.travelplanner.viewmodel

import ex2024travel.lofi_acl.travelplanner.model.TravelPlanModel
import ex2024travel.lofi_acl.travelplanner.view.{BucketListEntryListCell, ExpenseListEntryListCell, InvitationDialogScene}
