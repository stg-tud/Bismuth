...
import ex2024travel.lofi_acl.sync.{ConnectionManager, DeltaMapWithPrefix, MessageReceiver, RDTSync}
...
class FilteringAntiEntropy[RDT](localIdentity: PrivateIdentity,
