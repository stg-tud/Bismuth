package ex2026lofi_acl.travelplanner.viewmodel

import ex2026lofi_acl.travelplanner.model.TravelPlanModel
import ex2026lofi_acl.travelplanner.view.{BucketListEntryListCell, ExpenseListEntryListCell, InvitationDialogScene}
