package ex2026accessControl.travelplanner.viewmodel

import ex2026accessControl.travelplanner.model.TravelPlanModel
import ex2026accessControl.travelplanner.view.{BucketListEntryListCell, ExpenseListEntryListCell, InvitationDialogScene}
