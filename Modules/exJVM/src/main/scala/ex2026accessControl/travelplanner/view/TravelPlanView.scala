...
import ex2026accessControl.travelplanner.viewmodel.TravelPlanViewModel
...
class TravelPlanView(viewModel: TravelPlanViewModel) extends GridPane {
  ...
  shareButton.onAction() = _ => viewModel.createInviteButtonPressed()
  ...
  addBucketListEntryButton.onAction() = { _ =>
  ...
  addExpenseEntryButton.onAction() = { _ =>
