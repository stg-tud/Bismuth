...
import ex2014reswingexamples.millgame.MillBoardRenamed
import ex2014reswingexamples.millgame.types.{Black, Circle, Empty, Line, Point, Presentation, Rect, SlotIndex, White}
