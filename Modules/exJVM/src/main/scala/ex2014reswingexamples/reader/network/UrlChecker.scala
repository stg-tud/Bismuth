package ex2014reswingexamples.reader.network

import ex2014reswingexamples.reader.Observable
...
class UrlChecker {
  ...
  /** Try to increase confidence that the String is a valid feed url
    ...
    */
  val check: Observable[String, Either[String, URL]] = Observable { // #EVT //#EVT
