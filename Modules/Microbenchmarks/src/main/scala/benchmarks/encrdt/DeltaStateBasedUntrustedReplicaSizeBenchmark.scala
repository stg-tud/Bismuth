...
object DeltaStateBasedUntrustedReplicaSizeBenchmark extends DeltaStateUntrustedReplicaSizeBenchEnvironment {

  def main(args: Array[String]): Unit = {

    val csvFile =
      new PrintWriter(Files.newOutputStream(Paths.get("./benchmarks/results/delta_state_size_benchmark.csv")))
    println(csvHeader)
...
object DeltaStateBasedUntrustedReplicaSizeBenchmarkLinearScaling
    extends DeltaStateUntrustedReplicaSizeBenchEnvironment {
  def main(args: Array[String]): Unit = {
