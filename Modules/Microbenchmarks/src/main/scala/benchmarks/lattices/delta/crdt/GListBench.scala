...
class GListBench {
  ...
  @Benchmark
  def insertStart(): NamedDeltaBuffer[GrowOnlyList[Int]] = list.mod(_.insertAt(0, -1))

  @Benchmark
  def insertEnd(): NamedDeltaBuffer[GrowOnlyList[Int]] = list.mod(_.insertAt(listSize, -1))
}
